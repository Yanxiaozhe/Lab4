...
public class GUI_test extends JFrame {
    ...
    public GUI_test() {
        ...
        contentPane.add(f5);contentPane.add(f1);contentPane.add(f2);contentPane.add(f3);contentPane.add(f4);contentPane.add(f6);contentPane.add(panel);
        ...
        f1_adr.setText("C:/Users/ThinkPad/Documents/Tencent Files/452660955/FileRecv/111.txt");
                        ...
                        .addGroup(gl_p1.createSequentialGroup()
                            .addGroup(gl_p1.createParallelGroup(Alignment.LEADING, false)
                                .addGroup(gl_p1.createSequentialGroup()
                                    ...
                                    .addComponent(button))
                                .addComponent(f1_adr, GroupLayout.PREFERRED_SIZE, 368, GroupLayout.PREFERRED_SIZE))
                            .addGap(18)
            ...
            gl_p2.createParallelGroup(Alignment.LEADING)
                .addGroup(gl_p2.createSequentialGroup()
                    ...
                    .addGroup(gl_p2.createParallelGroup(Alignment.LEADING)
                        .addGroup(gl_p2.createSequentialGroup()
                            .addComponent(scrollPane_1, GroupLayout.PREFERRED_SIZE, 537, GroupLayout.PREFERRED_SIZE)
                            .addContainerGap(13, Short.MAX_VALUE))
                        .addGroup(gl_p2.createSequentialGroup()
                            .addComponent(lblNewLabel)
                            .addPreferredGap(ComponentPlacement.RELATED, 282, Short.MAX_VALUE)
                            .addComponent(f2_showGraph)
                            .addGap(24))))
        );
                ...
                .addGroup(gl_p3.createSequentialGroup()
                    ...
                    .addGroup(gl_p3.createParallelGroup(Alignment.LEADING, false)
                        ...
                        .addGroup(gl_p3.createSequentialGroup()
                            ...
                            .addGap(18)
                            .addGroup(gl_p3.createParallelGroup(Alignment.LEADING)
                                .addComponent(f3_w1, GroupLayout.PREFERRED_SIZE, 192, GroupLayout.PREFERRED_SIZE)
                                .addComponent(f3_w2))))
                    .addGap(50)
                    .addComponent(f3_query, GroupLayout.PREFERRED_SIZE, 110, GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(gl_p3.createParallelGroup(Alignment.LEADING)
                        .addGroup(gl_p3.createSequentialGroup()
                            ...
                            .addGroup(gl_p3.createParallelGroup(Alignment.BASELINE)
                                .addComponent(f3_w1, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE)
                                .addComponent(label_3))
                            .addPreferredGap(ComponentPlacement.UNRELATED)
                            .addGroup(gl_p3.createParallelGroup(Alignment.BASELINE)
                                .addComponent(f3_w2, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE)
                                .addComponent(label_4))
                            .addGap(42)
                            .addComponent(lblNewLabel_3))
                        .addGroup(gl_p3.createSequentialGroup()
                            .addGap(92)
                            .addComponent(f3_query, GroupLayout.PREFERRED_SIZE, 71, GroupLayout.PREFERRED_SIZE)))
                    .addGap(18)
                ...
                .addGroup(gl_p4.createSequentialGroup()
                    ...
                    .addGroup(gl_p4.createParallelGroup(Alignment.LEADING)
                        ...
                        .addGroup(gl_p4.createParallelGroup(Alignment.TRAILING, false)
                            .addGroup(Alignment.LEADING, gl_p4.createSequentialGroup()
                                .addComponent(label_1)
                                .addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(f4_create)
                                .addGap(18))
                            .addGroup(gl_p4.createSequentialGroup()
                                .addGroup(gl_p4.createParallelGroup(Alignment.LEADING)
                                    .addComponent(scrollPane_3, GroupLayout.PREFERRED_SIZE, 530, GroupLayout.PREFERRED_SIZE)
        ...
        gl_p4.setVerticalGroup(
            gl_p4.createParallelGroup(Alignment.TRAILING)
                .addGroup(gl_p4.createSequentialGroup()
                    ...
                    .addGroup(gl_p4.createParallelGroup(Alignment.TRAILING)
                        .addComponent(label_1)
                        .addComponent(f4_create, GroupLayout.PREFERRED_SIZE, 41, GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(ComponentPlacement.UNRELATED)
                    .addComponent(f4_in, GroupLayout.PREFERRED_SIZE, 77, GroupLayout.PREFERRED_SIZE)
                    .addGap(30)
                    .addComponent(lblNewLabel_4)
                    .addGap(18)
                ...
                .addGroup(gl_p5.createSequentialGroup()
                    ...
                    .addGroup(gl_p5.createParallelGroup(Alignment.LEADING)
                        .addGroup(gl_p5.createParallelGroup(Alignment.LEADING, false)
                            ...
                            .addGroup(gl_p5.createSequentialGroup()
                                .addGroup(gl_p5.createParallelGroup(Alignment.TRAILING)
                                    .addComponent(lbll)
                                    .addComponent(label_6))
                                .addGroup(gl_p5.createParallelGroup(Alignment.LEADING, false)
                                    .addGroup(gl_p5.createSequentialGroup()
                                        .addGap(16)
                                        .addComponent(f5_w1, GroupLayout.PREFERRED_SIZE, 143, GroupLayout.PREFERRED_SIZE))
                                    .addGroup(gl_p5.createSequentialGroup()
                                        .addGap(18)
                                        .addComponent(f5_w2))))
                            .addComponent(f5_1, GroupLayout.DEFAULT_SIZE, 251, Short.MAX_VALUE))
                        .addComponent(f5_w, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(gl_p5.createParallelGroup(Alignment.LEADING, false)
                        .addGroup(gl_p5.createSequentialGroup()
                            ...
                            .addGroup(gl_p5.createParallelGroup(Alignment.BASELINE)
                                ...
                                .addComponent(label_6))
                            .addGap(18)
                            .addComponent(f5_1, GroupLayout.PREFERRED_SIZE, 48, GroupLayout.PREFERRED_SIZE)
                            .addGap(74)
                            .addComponent(label_7)
                            .addGap(18)
                            .addComponent(f5_w, GroupLayout.PREFERRED_SIZE, 34, GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(ComponentPlacement.UNRELATED)
                            .addComponent(f5_2, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE))
                        .addGroup(gl_p5.createSequentialGroup()
                            .addGap(25)
                            .addComponent(lblNewLabel_5)
                            .addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(scrollPane_4, GroupLayout.PREFERRED_SIZE, 351, GroupLayout.PREFERRED_SIZE)))
                        ...
                        .addGroup(gl_p6.createSequentialGroup()
                            ...
                            .addGroup(gl_p6.createParallelGroup(Alignment.LEADING)
                                .addGroup(gl_p6.createSequentialGroup()
                                    .addGap(11)
                                    .addGroup(gl_p6.createParallelGroup(Alignment.LEADING)
                                        .addComponent(lblSuijiyouyo)
                                        .addComponent(f6_begin, GroupLayout.PREFERRED_SIZE, 156, GroupLayout.PREFERRED_SIZE))
                                    .addGap(98)
                                    .addGroup(gl_p6.createParallelGroup(Alignment.LEADING)
                                        .addComponent(label_2, GroupLayout.PREFERRED_SIZE, 106, GroupLayout.PREFERRED_SIZE)
                                        .addComponent(f6_choose, GroupLayout.PREFERRED_SIZE, 183, GroupLayout.PREFERRED_SIZE)))
